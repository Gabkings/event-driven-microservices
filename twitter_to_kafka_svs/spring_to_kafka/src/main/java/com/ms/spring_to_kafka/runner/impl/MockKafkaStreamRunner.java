...
import com.ms.spring_to_kafka.exception.TwitterToKafkaServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public MockKafkaStreamRunner(SpringToConfigData springToConfigData, TwitterKafkaStatusListener twitterKafkaStatusListener) {
    ...
    public void start() throws TwitterException {
        final String[] keywords = springToConfigData.getTwitterKeywords().toArray(new String[0]);
        final int minTweetLength = springToConfigData.getMockMinTweetLength();
        final int maxTweetLength = springToConfigData.getMockMaxTweetLength();
        long sleepTimeMs = springToConfigData.getMockSleepMs();
