...
public class TwitterV2StreamHelper {
    ...
    private final SpringToConfigData twitterToKafkaServiceConfigData;
    ...
    public TwitterV2StreamHelper(SpringToConfigData twitterToKafkaServiceConfigData,
    ...
    private void deleteRules(String bearerToken, List<String> existingRules) throws URISyntaxException, IOException {
        ...
        HttpEntity entity = response.getEntity();
        if (null != entity) {
            System.out.println(EntityUtils.toString(entity, "UTF-8") +" Test");
        }
    }
